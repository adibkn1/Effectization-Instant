...
extension ImageResource {
    ...
    static let noInternetClip = ImageResource(name: "noInternetClip", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "noInternetClip" asset catalog image.
    static var noInternetClip: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .noInternetClip)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "noInternetClip" asset catalog image.
    static var noInternetClip: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .noInternetClip)
#else
        .init()
