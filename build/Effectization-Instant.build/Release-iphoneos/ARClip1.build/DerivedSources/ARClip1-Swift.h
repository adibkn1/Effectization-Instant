...
#ifndef ARCLIP1_SWIFT_H
#define ARCLIP1_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ARClip1",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC7ARClip116ARViewController")
@interface ARViewController : UIViewController <ARSCNViewDelegate, ARSessionDelegate>
...
SWIFT_CLASS("_TtC7ARClip113CTAButtonView")
@interface CTAButtonView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

/// A view that shows an activity spinner with a descriptive label
SWIFT_CLASS("_TtC7ARClip111LoadingView")
...
SWIFT_CLASS("_TtC7ARClip114NoInternetView")
...
SWIFT_CLASS("_TtC7ARClip111OverlayView")
...
SWIFT_CLASS("_TtC7ARClip116QRViewController")
...
SWIFT_CLASS("_TtC7ARClip113SceneDelegate")
...
SWIFT_CLASS("_TtC7ARClip122TransparentVideoPlayer")
@interface TransparentVideoPlayer : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)observeValueForKeyPath:(NSString * _Nullable)keyPath ofObject:(id _Nullable)object change:(NSDictionary<NSKeyValueChangeKey, id> * _Nullable)change context:(void * _Nullable)context;
@end
